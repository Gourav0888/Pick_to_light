 ...
 * Author: Gourav Singh
 *
 * Created on 20 February, 2025, 12:36 PM
 */
...
unsigned char can_receive(void)
{
	...
	if (RXB0FUL) /* CheckRXB0 */
	{
		...
		can_payload[D0] = RXB0D0 - '0';
		can_payload[D1] = RXB0D1 - '0';
		can_payload[D2] = RXB0D2 - '0';
		can_payload[D3] = RXB0D3 - '0';
		can_payload[D4] = RXB0D4 - '0';
		can_payload[D5] = RXB0D5 - '0';
		can_payload[D6] = RXB0D6 - '0';
		can_payload[D7] = RXB0D7 - '0';
...
void can_transmit(void)
{
	...
	TXB0D0 = c0 + '0';			/* DataByte 0 */
	TXB0D1 = c1 + '0';			/* DataByte 1 */
	TXB0D2 = c2 + '0';			/* DataByte 2 */
	TXB0D3 = c3 + '0';			/* DataByte 3 */
	TXB0D4 = c4 + '0';			/* DataByte 4 */
	TXB0D5 = c5 + '0';			/* DataByte 5 */
	TXB0D6 = c6 + '0';			/* DataByte 6 */
	TXB0D7 = c7 + '0';			/* DataByte 7 */
